...
<body>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" >
                        <div class="nav-item dropdown">
                            ...
                            ?>
                            @foreach($cate as $cat)
                            <a href="{{route('category.show', $cat->id)}}" class="nav-item nav-link"> {{ $cat->name }} </a>
                            @endforeach
                    </div>
                </nav>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">E</span>Sách</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{route('category.index')}}" class="nav-item nav-link">Cửa hàng</a>
                            ...
                            <div class="navbar-nav ml-auto py-0">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src="{{asset('/Storage/' .Auth::user()->avatar)}}" alt="" class="rounded-circle" style="width: 30px; height: 30px;">
                                        {{ Auth::user()->fullname }}
                                    </button>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('profile', Auth::user()->id) }}" class="dropdown-item text-center">Trang cá nhân</a>
                                        </li>
    ...
    <script src="{{asset('asset/mail/contact.jsv')}}"></script>
